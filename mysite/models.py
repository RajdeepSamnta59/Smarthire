...
class PostJob(models.Model):
    ...
    job_code = models.CharField(max_length=3, unique=True, blank=True, null=True)
    required_skills = models.TextField(default="", help_text="Comma-separated skills")
...
class Apply_job(models.Model):
    ...
    parsed_text = models.TextField(default="", blank=True)
